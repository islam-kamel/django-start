...
class ProjectLayout:
    """
    Immutable representation of deterministic, stable paths
    in the generated project.

    Contains only safe, conceptual paths derived from project configuration.
    Does not read from the filesystem or include
    unresolved infrastructure paths.
    """
    ...
    def from_config(cls, config: ProjectConfig) -> "ProjectLayout":
        """Derive the deterministic project layout
