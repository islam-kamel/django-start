...
def test_check_available_when_newer(capsys):
    with patch("djstartlib.version.latest_version", return_value=("2.0.0", [2, 0, 0])):
...
def test_full_scaffold_lifecycle(isolated_workdir):
    ...
    with patch("djstartlib.models.djstart_interface.create_env") as mock_create_env, \
         patch("djstartlib.models.project_manager.executable_django_command") as mock_dj_cmd, \
         ...
         patch("djstartlib.models.app_manager.executable_python_command") as mock_py_cmd:
